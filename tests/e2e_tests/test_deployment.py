...
def test_deployment(tmp_project, cli_options, request):
    """Test the full, live deployment process to CodeRed."""

    # Cache the platform name for teardown work.
    request.config.cache.set("platform", "dsd_codered")

    print("\nTesting deployment to CodeRed using the following options:")
